...
export function EditorWorkspace({ editor }: { editor: EditorState }) {
  const {
    ...
    handleCropPositionChange, handleCropAreaChange, preview, updateFitContainerSize, exportFormat, exportQuality, backgroundColor, setIsExportOpen, mobilePanel, setMobilePanel,
  } = editor;
