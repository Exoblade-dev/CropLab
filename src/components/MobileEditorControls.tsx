import { Crop, Download, FlipHorizontal, History, MoreHorizontal, SlidersHorizontal, RotateCw, RotateCcw, Trash2, Undo2, Redo2, X, ZoomIn, ZoomOut, FileInput, RotateCcw as ResetIcon, StretchHorizontal, Lock, Unlock, Maximize2 } from 'lucide-react';
